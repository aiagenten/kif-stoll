...
const statusConfig: Record<string, { label: string; variant: 'secondary' | 'success' | 'default' | 'destructive' | 'warning' | 'outline'; icon: React.ElementType }> = {
  draft:     { label: 'Utkast',    variant: 'secondary',    icon: FileText },
  approved:  { label: 'Godkjent',  variant: 'success',      icon: CheckCircle },
  scheduled: { label: 'Planlagt',  variant: 'outline',      icon: Clock },
  published: { label: 'Publisert', variant: 'default',      icon: Send },
    ...
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => navigate('/admin/some/settings')}>
            <Settings className="w-4 h-4" />
            Innstillinger
          </Button>
          <Button onClick={() => navigate('/admin/some/new')}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <Card key={stat.label} className="bg-[#1C244B] border-[#1C244B]">
      ...
      {loading ? (
        ...
        <Card className="text-center py-16">
          <CardContent className="pt-6">
            ...
            <Button className="mt-4" onClick={() => navigate('/admin/some/new')}>
              Lag første innlegg
            </Button>
          </CardContent>
        </Card>
      ...
      {posts.filter(p => p.status === 'scheduled').length > 0 && (
        <Card className="bg-[#1C244B] border-[#1C244B]">
